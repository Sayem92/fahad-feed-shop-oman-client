    ...
    <section className=" ">
      <div className="container flex flex-col justify-center p-2 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
          <img
            src="https://i.ibb.co/FhtH3nW/rescued-goats-eating-oats-for-lunch.jpg"
            alt="phone sell"
        ...
        <div className="flex flex-col justify-center p-6 rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          <h1 className="text-5xl font-semibold leading-none sm:text-6xl">
            BEST PLACE TO <span className="text-orange-500">BUY</span> YOUR
            Products
          </h1>
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            Animals Feed most trusted platform to Buy your animals foods, you
            can order any products and easily paid online. Home delivery are
            possible.
          </p>
        </div>
      </div>
